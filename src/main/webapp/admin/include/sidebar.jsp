       ...
       <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li class="menu-label">Operation</li>
             <li>
              <a href="javascript:;" class="has-arrow">
                <div class="parent-icon"><i class="bi bi-bank"></i>
                </div>
                <div class="menu-title">Bank</div>
              </a>
              <ul>
                <li> <a href="addBank.jsp"><i class="bi bi-plus-circle-fill"></i>Add Bank</a>
                </li>
                <li> <a href="viewBank.jsp"><i class="bi bi-eye-fill"></i>View Bank</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul>
                <li> <a href="AddCustomer.jsp"><i class="bi bi-plus-circle-fill"></i>Add Customer</a>
                </li>
                <li> <a href="ViewCustomer.jsp"><i class="bi bi-eye-fill"></i>View Customer</a>
                </li>
              </ul>
            </li>
