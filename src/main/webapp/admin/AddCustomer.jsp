                ...
                <div class="card">
                    <div class="card-body">
                        <form id="myform" method="POST" enctype="multipart/form-data">
                            <!-- First Name -->
                            <input class="form-control form-control-lg mb-3" type="text" name="custFname" placeholder="Enter First Name" aria-label=".form-control-lg example" required>
...
<%--                            <input class="form-control form-control-lg mb-3" type="text" name="custuserId" placeholder="Enter User Id" aria-label=".form-control-lg example" required>--%>
                            ...
                            <!-- Password -->
                            <input class="form-control form-control-lg mb-3" type="password" name="custPass" placeholder="Enter Password" aria-label=".form-control-lg example" required>

                            <!-- Date of Birth -->
                            <input class="form-control form-control-lg mb-3" type="date" name="custDOB" aria-label=".form-control-lg example" required>

                            <!-- Phone Number -->
                            <input class="form-control form-control-lg mb-3" type="text" name="custPhone" placeholder="Enter Phone Number" aria-label=".form-control-lg example" required>

                            <!-- Address -->
                            <input class="form-control form-control-lg mb-3" type="text" name="custAddress" placeholder="Enter Address" aria-label=".form-control-lg example" required>

                            <!-- Image Upload -->
                            <input class="form-control form-control-lg mb-3" type="file" name="custImg" aria-label=".form-control-lg example" required>
